...
# Sample导入 ----
Sample <- read_excel("01_rawdata/glycoproteome_discovery_third.xlsx")
View(Sample)
...
markers <- blood_vars
Sample1 <- read_excel("01_rawdata/glycoproteome_discovery_third.xlsx")
View(Sample1)
...
ggsave("./04_figure/Trend_by_Marker_Data1_discoverythird.pdf", p1, width = 14, height = 14, dpi = 300)
ggsave("./04_figure/Trend_by_Marker_Data2_discoverythird.pdf", p2, width = 14, height = 14, dpi = 300)
